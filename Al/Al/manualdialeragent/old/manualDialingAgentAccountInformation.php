...
$crmData = mysql_query("select *from manualDialing where assignAgent='$extension' AND dialingStatus!='Called'");
$callbackData = mysql_query("select *from manualDialing where dialingStatus='Called' AND dialingComment='Call Back' AND assignAgent='$extension' AND UNIX_TIMESTAMP(callBackFromDateTime) >= UNIX_TIMESTAMP('$today')");
?>
<html>
<head>
...
//	{
?>
<meta http-equiv="refresh" content="10;URL=manualDialingAgentAccountInformation.php">
<?php
/*	}
	else 
	{
	...
	<td align="center" class="NormalFont">
		...
		<?php
				...
				echo "<tr bgcolor='#f6f6f6'>
						...
						<td align='left'><a href='javascript:void(0)' onclick=\"window.open('agentManualCallAccountInformation.php?id=".$crm['dialingId']."&act=manual','','scrollbars = yes,resizable=yes,width=1000,height=800');\" class=NormalFont>View&Call</a></td>
					  </tr>	
					 ";
				}
				else
