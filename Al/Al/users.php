...
<script language="javascript">
    ...
    function blockuser() {
        if (document.users.usersvalue.value == "") {
            ...
            if (confirm("Are you sure you want to block") == true) {
                document.users.method = "post";
                document.users.action = "./userBlockUnBlock.php?id=block";
                document.users.submit();
            }
        }
    }
    function unblockuser() {
        if (document.users.usersvalue.value == "") {
            ...
            if (confirm("Are you sure you want to unblock") == true) {
                document.users.method = "post";
                document.users.action = "./userBlockUnBlock.php?id=unblock";
                document.users.submit();
            }
        }
    }
    function edituser() {
        ...
        if (document.users.usersvalue.value == "") {
            ...
            document.users.usersvalue.focus();
               ...
               document.users.method = "post";
                document.users.action = "./editUser.php";
                document.users.submit();
            }
    }
...
<tr>
   ...
   <td width=100% valign=top>
    <table class="mainscreenTable" align="center" width="100%" border=0 class="NormalFont">
    <tr>
    ...
    <input type=button class=NormalButton name="Activate Changes" value="Activate Changes" onclick="javascript:activate();">
    
    </td>
    </tr>
	<tr valign="top">
	    <td align=center class=normalfont>User Extensions: </td>	
		
	</tr>
	<tr valign="top">
		<td width="50%" height=350px align=center>
<?php
$j=0;
...
for($i_Int=0;$i_Int<count($file2);$i_Int++){
	...
	if(strstr($file2[$i_Int],"DLPN_")){
		...
		if($strPlanName != ""){
			$userDialplanArr[$j_Int] = $dialPlan." - ".$strPlanName;
		}else{
...
?>
 <select size="25" id="usersvalue" style="width:50%; height:350px"  name="usersvalue" onchange="javascript:editUserExtension();" class="Mandatorytextbox">
<option value="0" style="color:Grey"> -Select User- </option>
<?php
...
?>
		...
		<td style="width:100px; height: 300px" align=center>
		    <select id='extensions' style='display:none;width:0px;height:0px'>
		    </select>
			<!--div id='adjustments' style='width:50'-->
...
<table border=0 width=100% cellpadding=0 cellspacing=0>
				...
				<tr>
				    <td class="Normalfont" tip="en,users,1" style="display:block" id="NameTrue">
				        <label id="NameLbl"> Name:</label>
				    </td>
				    <td>
				        <input size='20' maxlength=50 id='fullname' pattern='^[a-zA-Z_0-9]*$' class="NormalTextBox" name="fullname" onfocus="this.style.backgroundColor='#E2E2E2'" onblur="this.style.backgroundColor='white'">
				    </td>
				</tr>
				<tr>
				    
				    <td id="ExtFalse" class="Normalfont" tip="en,users,0" style="display:block">
...
<input type="hidden" name="userOperation" id="userOperation" value="new">
				    ...
				    <td>
				        <input maxlength=4 id='extension' pattern='?[0-9]+' class=NormalTextBox name="extension"  onfocus="this.style.backgroundColor='#E2E2E2'" onblur="javascript:isInteger(this);">
				    </td>
				</tr>
				...
				<tr >
				    <td  class="Normalfont" tip="en,users,2" style="display:block" id="PassTrue">
					<table border=0 cellpadding=0 cellspacing=0>
					<tr class="Normalfont" tip="en,users,16" id="pass1" style="display:block;">
					<td>
					...
					<td class="Normalfont" tip="en,users,16">
				        <input type=password   id='secret'  class="NormalTextBox" pattern='^[a-zA-Z_0-9]*$'   name="secret" onfocus="this.style.backgroundColor='#E2E2E2'" onblur="this.style.backgroundColor='white'">
					</td></tr></table>
				    </td>
				</tr>
				<tr >
				    <td class="Normalfont" tip="en,users,16" style="display:block" id="VMPassTrue">
				       <table border=0 cellpadding=0 cellspacing=0>
						<tr class="Normalfont" tip="en,users,16" id="secret1" style="display:block;"><td>
						 <label id="VMPassLbl">VM Password:</label>
						</td></tr>
					</table>
				    </td>
				    <td>
					<table border=0 cellpadding=0 cellspacing=0>
						<tr class="Normalfont" tip="en,users,16" id="sec1" style="display:block;"><td class="Normalfont" tip="en,users,16" >
						        <input type=password size='20' id='vmsecret'   class="NormalTextBox" pattern='^[0-9*]*$'   name="vmsecret"  onfocus="this.style.backgroundColor='#E2E2E2'" onblur="this.style.backgroundColor='white'">
						</td></tr>
					</table>
				    </td>
				</tr>
				<span id="noanaloglines" style="display:none" class="NormalTextBox"><I>&nbsp;No Analog lines detected.</I></span>


				<tr>
				    <td class="Normalfont" tip="en,users,25" style="display:block" id="emailTrue">
				        <label id="NameLbl"> Email:</label>
				    </td>
				    <td>
				        <input size='20' id='email'  class="NormalTextBox" pattern='^[0-9a-zA-Z\.\-\_\@]*$'  name="email">
				    </td>
				</tr>
				
				<tr>
				    <td class="Normalfont" tip="en,users,26" style="display:block" id="callerIdTrue">
				        <label id="NameLbl"> Caller Id:</label>
				    </td>
				    <td>
				       <input size='20' id='cid_number'  pattern='^[\d\-]*$' class="NormalTextBox" name="cid_number" onfocus="this.style.backgroundColor='#E2E2E2'" onblur="this.style.backgroundColor='white'">
				    </td>
				</tr>

				<tr><td class="Normalfont" tip="en,users,6">Dial Plan:</td>
				    <td><select size='1' id='context' style='width:135px' class="DropDownBox" name="context">
				    <option value="" ></option>
<?php
...
<fieldset style="width:90%">
				...
				<table align='center' width=100% cellpadding=1 border=0 cellspacing=1>
				<tr>
					<td width=10 align=right><input type='checkbox' id='hasvoicemail' onclick="javascript:voicemailoption();" name="hasvoicemail"></td >
					<td class="Normalfont" tip="en,users,8">Voicemail</td>

					<td align=right><input type='checkbox' id='hasdirectory' name="hasdirectory"></td>
					<td class="Normalfont" tip="en,users,9">In Directory</td>
				</tr>
				
				<tr>
					<td align=right><input type='checkbox' onclick="javascript:sipoption();" id='hassip' name="hassip"></td>
					<td class="Normalfont" tip="en,users,10" style="display:block" id="SIPTrue"><label id="SIPLbl">SIP</label></td>
					
					<td align=right><input type='checkbox' id='hasiax' name="hasiax"></td>
					<td class="Normalfont" tip="en,users,11">IAX</td>
				</tr>
				<tr>
					<td align=right><input type='checkbox' id='hasagent' name="hasagent"></td>
					<td class="Normalfont" tip="en,users,23" style="display:block" id="agentTrue"><label id="SIPLbl">Is Agent</label></td>
					
					<td align=right><input type='checkbox' id='cti' name="cti"></td>
					<td class="Normalfont" tip="en,users,24">CTI</td>
				</tr>
				<tr>
				<td align=right> <input type='checkbox' id='registersip' name='registersip'></td>
					<td class="Normalfont" tip="en,users,23" style="display:block" id="agentTrue"><label id="SIPLbl">Register SIP</label></td>
					<td align=right> <input type='checkbox' id='registeriax' name='registeriax'></td>
					<td class="Normalfont" tip="en,users,23" style="display:block" id="agentTrue"><label id="SIPLbl">Register IAX</label></td>
		...
		<tr>	
		        ...
		        <td align='center'>
		            <input type='button' id='new' value='New' class=NormalButton onclick="javascript:newUser();">
		            <input type='button' id='delete' value='Delete' onclick="javascript:deleteUserExtension();" class=NormalButton disabled>
		        </td>
				<td >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='button' id='save' value='Save'  class=NormalButton onclick="validate();">&nbsp;&nbsp;<input type='button' id='cancel' value='Cancel' class=NormalButton onclick="location.href='home.php'"></td>
		</tr>
</table>
</table>
<script language="javascript">
