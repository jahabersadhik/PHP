...
<td width="150" class="NormalFont">
	<span id="responseComment<?php echo $No; ?>"><A style="COLOR: black; TEXT-DECORATION: none" href="manualAgentReport.php?ID=<?php echo $rowusers['extensionNo']; ?>">View</A></span>
...
function submitform()
{
	document.getElementById('catcampform').action="./manualDialingReport.php";
