		...
		xmlhttp.onreadystatechange=function()
		{
			if(xmlhttp.readyState==4){
				if(xmlhttp.responseText){
			  		document.getElementById('responseText').innerHTML = "<font color='green'>iSystem Reloaded</font>";
			  		setTimeout('document.getElementById(\'responseText\').innerHTML = \"\"',3000);
				}else{
					document.getElementById('responseText').innerHTML = "<font color='red'>Failed</font>";
					setTimeout('document.getElementById(\'responseText\').innerHTML = \"\"',3000);
				}
			}
		}
