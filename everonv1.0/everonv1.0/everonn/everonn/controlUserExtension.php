...
if($_GET['action'] == 'save'  && $_GET['task'] == 'users')
{
	...
	{
		$ch = curl_init();
		$saveUrl1 = "https://$IPAddress/asterisk/rawman?action=updateconfig&srcfilename=users.conf&dstfilename=users.conf&Action-000000=update&Cat-000000=".$_GET['extension']."&Var-000000=fullname&Value-000000=".str_replace(" ","%20",$_GET['fullname'])."&Action-000001=update&Cat-000001=".$_GET['extension']."&Var-000001=context&Value-000001=".$_GET['context']."&Action-000002=update&Cat-000002=".$_GET['extension']."&Var-000002=hasvoicemail&Value-000002=".(($_GET['hasvoicemail'] != "")?$_GET['hasvoicemail']:"yes")."&Action-000003=update&Cat-000003=".$_GET['extension']."&Var-000003=vmsecret&Value-000003=".$_GET['vmsecret']."&Action-000004=update&Cat-000004=".$_GET['extension']."&Var-000004=email&Value-000004=".$_GET['email']."&Action-000005=update&Cat-000005=".$_GET['extension']."&Var-000005=secret&Value-000005=".$_GET['secret'];
		$urlDetailsName1 = "Action-000000=update&Cat-000000=".$_GET['extension']."&Var-000000=fullname&Value-000000=".str_replace(" ","%20",$_GET['fullname'])."&Action-000001=update&Cat-000001=".$_GET['extension']."&Var-000001=context&Value-000001=".$_GET['context']."&Action-000002=update&Cat-000002=".$_GET['extension']."&Var-000002=hasvoicemail&Value-000002=".(($_GET['hasvoicemail'] != "")?$_GET['hasvoicemail']:"yes")."&Action-000003=update&Cat-000003=".$_GET['extension']."&Var-000003=vmsecret&Value-000003=".$_GET['vmsecret']."&Action-000004=update&Cat-000004=".$_GET['extension']."&Var-000004=email&Value-000004=".$_GET['email']."&Action-000005=update&Cat-000005=".$_GET['extension']."&Var-000005=secret&Value-000005=".$_GET['secret']."&Action-000006=update&Cat-000006=".$_GET['extension']."&Var-000006=context&Value-000006=".$_GET['context'].""; 
		...
		{
			$allow = ($_GET['allow'] != "")?$_GET['allow']:"all";
		...
		$providedModificationValues .= "~contextname,".$_GET['contextname'];
		$oldvaluesquery = mysql_query("select trackInformation from userAccessTracking WHERE name = 'Extensions/Edit' AND trackExtension = '".$_GET['extension']."' ORDER BY trackId DESC LIMIT 0,1",$connection);
		$oldvaluesresult =mysql_fetch_row($oldvaluesquery);
		if($oldvaluesresult[0] != $providedModificationValues)
		{
			$insertUserTracking = "insert into userAccessTracking set userName='".$_SESSION['username']."',trackDate='".date("Y-m-d H:i:s")."',name='Extensions/Edit',trackFunction='$oldvaluesresult[0]',trackExtension='".$_GET['extension']."',trackInformation='".$providedModificationValues."'";
		...
		$ch = curl_init();
		$urlDetailsName1 = "Action-000000=delcat&Cat-000000=".$_GET['extension']."&Var-000000=&Value-000000=&Action-000001=newcat&Cat-000001=".$_GET['extension']."&Var-000001=&Value-000001=";
		...
		$ch = curl_init();
		$urlDetailsName3 = "&Action-000000=append&Cat-000000=".$_GET['extension']."&Var-000000=fullname&Value-000000=".str_replace(" ","%20",$_GET['fullname'])."&Action-000001=append&Cat-000001=".$_GET['extension']."&Var-000001=context&Value-000001=".$_GET['context']."&Action-000002=append&Cat-000002=".$_GET['extension']."&Var-000002=hasvoicemail&Value-000002=".(($_GET['hasvoicemail'] != "")?$_GET['hasvoicemail']:"yes")."&Action-000003=append&Cat-000003=".$_GET['extension']."&Var-000003=vmsecret&Value-000003=".$_GET['vmsecret']."&Action-000004=append&Cat-000004=".$_GET['extension']."&Var-000004=email&Value-000004=".$_GET['email']."&Action-000005=append&Cat-000005=".$_GET['extension']."&Var-000005=threewaycalling&Value-000005=".(($_GET['threewaycalling'] != "")?$_GET['threewaycalling']:"yes")."&Action-000006=append&Cat-000006=".$_GET['extension']."&Var-000006=hasdirectory&Value-000006=".(($_GET['hasdirectory'] != "")?$_GET['hasdirectory']:"yes")."&Action-000007=append&Cat-000007=".$_GET['extension']."&Var-000007=callwaiting&Value-000007=".(($_GET['callwaiting'] != "")?$_GET['callwaiting']:"yes")."&Action-000008=append&Cat-000008=".$_GET['extension']."&Var-000008=hasmanager&Value-000008=".(($_GET['hasmanager'] != "")?$_GET['hasmanager']:"no")."&Action-000009=append&Cat-000009=".$_GET['extension']."&Var-000009=nat&Value-000009=".(($_GET['nat'] != "")?$_GET['nat']:"yes")."&Action-000010=append&Cat-000011=".$_GET['extension']."&Var-000010=canreinvite&Value-000010=".(($_GET['canreinvite'] != "")?$_GET['canreinvite']:"yes")."&Action-000011=append&Cat-000011=globals&Var-000011=CID_".$_GET['extension']."&Value-000011=".$_GET['extension']."&Action-000012=append&Cat-000012=".$_GET['extension']."&Var-000012=disallow&Value-000012=".(($_GET['disallow'] != "")?$_GET['disallow']:"all")."&Action-000013=append&Cat-000013=".$_GET['extension']."&Var-000013=allow&Value-000013=".(($_GET['allow'] != "")?$_GET['allow']:"all")."&Action-000014=append&Cat-000014=".$_GET['extension']."&Var-000014=autoprov&Value-000014=".(($_GET['autoprov'] != "")?$_GET['autoprov']:"no")."&Action-000015=append&Cat-000015=".$_GET['extension']."&Var-000015=hasagent&Value-000015=".(($_GET['hasagent'] != "")?$_GET['hasagent']:"no")."";
...
if($_GET['action'] == 'delete'  && $_GET['task'] == 'users')
{
	...
	$providedModificationValues = "Extension Deleted";
	$oldvaluesquery = mysql_query("select trackInformation from userAccessTracking WHERE (name = 'Extensions/Edit' OR name = 'Extensions/Delete') AND trackExtension = '".$_GET['extension']."' ORDER BY trackId DESC LIMIT 0,1",$connection);
	$oldvaluesresult =mysql_fetch_row($oldvaluesquery);
	if($oldvaluesresult[0] != "Extension Deleted")
	{
		$insertUserTracking = "insert into userAccessTracking set userName='".$_SESSION['username']."',trackDate='".date("Y-m-d H:i:s")."',name='Extensions/Delete',trackFunction='$oldvaluesresult[0]',trackExtension='".$_GET['extension']."',trackInformation='Extension Deleted'";
