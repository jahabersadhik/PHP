<?php
	$date = date("Y-m-d");
	$customerList = mysql_query("SELECT accountId,firstname,lastname,email,address,phone FROM predictiveDialing WHERE callDate='$date'");
 	...
 	while($customerListResult = mysql_fetch_row($customerList))
	{
		echo "<tr>
	 			...
	 			<td width='25%'>$customerListResult[3]</td>
	 			<td width='40%'>$customerListResult[4]</td>
	 			<td width='10%'>$customerListResult[5]</td>
	 		  </tr>";
	}
	echo "</table>";
?>
