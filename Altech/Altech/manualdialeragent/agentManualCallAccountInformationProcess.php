...
if($url != ""){ 
	...
	$sql_inser = mysql_query("INSERT into comment values (NULL,'$phone','$calledextension','$callDate','$dialerDispostion','".$_REQUEST['userDisposition']."','$status','".$callBack."','".$_REQUEST['txtCDesc']."','".$agentComment."','0','$processid')");
