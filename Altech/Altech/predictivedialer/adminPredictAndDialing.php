<?php
	if($_POST['submit'])
	{
		...
		for($i=0;$i<count($checkedCustomers);$i++)
		{
			...
			mysql_query("INSERT INTO predictiveDialing(accountId,callDate,firstname,lastname,email,address,phone,process) VALUES('$customerDetails[0]','$customerDetails[1]','$customerDetails[2]','$customerDetails[3]','$customerDetails[4]','$customerDetails[5]','$customerDetails[6]','$process')");
			header("location:../home.php?page=predictivemain2");
		}
		else
		header("location:../home.php?page=predictivemain");
	}
?>
<form method="post" action="predictivedialer/adminPredictAndDialing.php">
<?php
